...
<section>
	<div class="container d-flex justify-content-center">
		<div class="kakao-enroll-container" style="width:600px; border:1px solid black; margin-top:50px;">
			...
			<form action="${path}/member/kakaoEnroll.do" method="post" onsubmit="return fn_checkEndK();" >
				<input type="hidden" name="m_Id" value="${kname}">
				<input type="hidden" name="m_Pw" value="1234a">
				<input type="hidden" name="m_Name" value="${kname}">
				<table>
					<tr>
						<th>전화번호</th>
					...
					<tr>
						...
						<td class="emailMsg-container">
							<input type="email" id="email" name="m_Email" class="form-control">
