...
<section>
	<div class="container d-flex justify-content-center">
		<div class="updatePw-container" style="border: 1px solid black; margin-top:50px; width:600px;">
			...
			<div class="updatePw-form d-flex justify-content-center">
				<form action="${path}/member/updateBusinessPwEnd.do" method="post" onsubmit="return fn_checkPwB();">
					<table>
						<tr>
							<th>변경할 비밀번호</th>
							<td class="pwMsg-container">
								<input type="password" class="form-control" name="b_pw" id="pw" placeholder="비밀번호 입력">
						...
						<tr>
							...
							<td class="pwckMsg-container">
								<input type="password" class="form-control" name="b_pwck" id="pwck" placeholder="비밀번호 확인" style="width:300px;">
								<span class="pwckMsg ok1">비밀번호가 일치합니다.</span>
								<span class="pwckMsg no1">비밀번호가 일치하지 않습니다.</span>
							</td>
							<td><input type="hidden" name="b_id" value="${b_id }"></td>
						</tr>
					</table>
